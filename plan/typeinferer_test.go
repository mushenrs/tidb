...
func (ts *testTypeInferrerSuite) TestInferType(c *C) {
	...
	cases := []struct {
		...
		// Functions
		{"version()", mysql.TypeVarString, charset.CharsetUTF8},
		...
		{"dayname('2007-02-03')", mysql.TypeVarString, charset.CharsetUTF8},
		{"version()", mysql.TypeVarString, charset.CharsetUTF8},
		{"database()", mysql.TypeVarString, charset.CharsetUTF8},
		{"schema()", mysql.TypeVarString, charset.CharsetUTF8},
		{"user()", mysql.TypeVarString, charset.CharsetUTF8},
		{"current_user()", mysql.TypeVarString, charset.CharsetUTF8},
		{"CONCAT('T', 'i', 'DB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"CONCAT_WS('-', 'T', 'i', 'DB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"left('TiDB', 2)", mysql.TypeVarString, charset.CharsetUTF8},
		{"lower('TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"lcase('TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"repeat('TiDB', 3)", mysql.TypeVarString, charset.CharsetUTF8},
		{"replace('TiDB', 'D', 'd')", mysql.TypeVarString, charset.CharsetUTF8},
		{"upper('TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"ucase('TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"trim(' TiDB ')", mysql.TypeVarString, charset.CharsetUTF8},
		{"ltrim(' TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"rtrim('TiDB ')", mysql.TypeVarString, charset.CharsetUTF8},
		...
		{"case c_int when null then 2 when 2 then 'tidb' else 1.1 END", mysql.TypeVarString, charset.CharsetUTF8},
		{"case c_int when null then c_char when 2 then c_float else 1.1 END", mysql.TypeString, charset.CharsetUTF8},
		{"case c_int when null then c_binary when 2 then c_float else 1.1 END", mysql.TypeString, charset.CharsetBin},
		// least() is the same as greatest()
		{"greatest('TiDB', 'D', 'd')", mysql.TypeVarString, charset.CharsetUTF8},
		...
		{"greatest(c_varchar, c_text)", mysql.TypeBlob, charset.CharsetUTF8},
		...
		{"greatest(c_enum, c_set)", mysql.TypeString, charset.CharsetUTF8},
		...
		{"hex('TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"hex(12)", mysql.TypeVarString, charset.CharsetUTF8},
		{"unhex('TiDB')", mysql.TypeVarString, charset.CharsetUTF8},
		{"unhex(12)", mysql.TypeVarString, charset.CharsetUTF8},
		{"DATE_FORMAT('2009-10-04 22:23:00', '%W %M %Y')", mysql.TypeVarString, charset.CharsetUTF8},
		...
		{`aes_encrypt("pingcap", "fit2cloud@2014")`, mysql.TypeVarString, charset.CharsetUTF8},
		{`aes_decrypt("pingcap", "fit2cloud@2014")`, mysql.TypeVarString, charset.CharsetUTF8},
		{`md5(123)`, mysql.TypeVarString, charset.CharsetUTF8},
		{`sha1(123)`, mysql.TypeVarString, charset.CharsetUTF8},
    ...
    {`sha2(123, 256)`, mysql.TypeVarString, charset.CharsetUTF8},
		...
		{`coalesce(c_int, c_char)`, mysql.TypeString, charset.CharsetUTF8},
		{`coalesce(c_int, c_binary)`, mysql.TypeString, charset.CharsetBin},
		{`coalesce(c_int, c_int)`, mysql.TypeLong, charset.CharsetBin},
